	...
	IN OUT	ADD_HT_INFO_IE 		*pAddHtInfo)
{
	...
	if (pAd->CommonCfg.Channel < 14) {
		pAd->ApCliMlmeAux.AddHtInfo.AddHtInfo.RecomWidth = pAddHtInfo->AddHtInfo.RecomWidth;
		pAd->ApCliMlmeAux.AddHtInfo.AddHtInfo.ExtChanOffset = pAddHtInfo->AddHtInfo.ExtChanOffset;
		pAd->ApCliMlmeAux.AddHtInfo.ControlChan = pAddHtInfo->ControlChan;
	}
